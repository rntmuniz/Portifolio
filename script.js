...
let buttonsList = [
    ...
    {'icon':'bx bxs-pencil', 'title': 'Formacao', 'body': '* Lienciatura em Ciências da Computação - UESPI (2006); <br>* Pós Graduação Análise de Sistemas - FAP (2007); <br>* Técnico em Informática - CEFET PI (2008); <br>* Pós Gradução Análise Forense e Perícia Digital - IPOG (2019); <br>* MBA Cybersegurança - FIAP (2023); <br>* Certificação em CyberSegurança - IBSEC (Junho/2024);'},
    {'icon':'bx bxs-landmark', 'title': 'Experiencia', 'body': '* Técnico em Informática - Prefeitura Municipal de Parnaíba (7 anos); <br>* Professor Efetivo de Computação - SEDUC PI (1 ano); <br>* Assessor de TI - Banco do Brasil (11/13 anos);'},
...
function abrirModal(title, body){
    ...
    <a href="https://www.google.com">Calculadora Plus HTML</a>`;
